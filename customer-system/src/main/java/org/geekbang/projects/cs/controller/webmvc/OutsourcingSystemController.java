...
public class OutsourcingSystemController {
    ...
    public Result<Long> addOutsourcingSystem(@RequestBody AddOutsourcingSystemReqVO addOutsourcingSystemReqVO) {
        ...
        //数据转换
        OutsourcingSystem outsourcingSystem = OutsourcingSystemConverter.INSTANCE.addOutsourcingSyatemReqVOToCustomerStaff(addOutsourcingSystemReqVO);
    ...
    public Result<OutsourcingSystemRespVO> findOutsourcingSystemById(@PathVariable("systemId") Long systemId) {
        ...
        OutsourcingSystemRespVO outsourcingSystemRespVO = OutsourcingSystemConverter.INSTANCE.customerStaffToOutsourcingSystemRespVO(outsourcingSystem);
    ...
    public Result<PageObject<OutsourcingSystemRespVO>> findOutsourcingSystems(@PathVariable("pageSize") Long pageSize, @PathVariable("pageIndex") Long pageIndex) {
        ...
        List<OutsourcingSystemRespVO> outsourcingSystemRespVOs = OutsourcingSystemConverter.INSTANCE.customerStaffToOutsourcingSystemRespVOs(pagedOutsourcingSystem.getList());
